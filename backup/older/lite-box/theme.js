...
// Start article 5 | Start Navbar Menu => Sticky
	...
	var navbar = document.getElementById("article_5");
...
// Start Spy Scroll
	...
	$.each(sectionArray, function(index, value){
		$(document).scroll(function(){
			var offsetSection = $('#' + 'nav_spy_' + value).offset().top;
		...
		$('li a').eq(index).click(function(e){
			var offsetClick = $('#' + 'nav_spy_' + value).offset().top;
			e.preventDefault();
			$('html, body').animate({
		...
		$(window).scroll(function(){
			$('svg.radial-progress').each(function( index, value ) { 
				...
				if ( 
					...
					// Transition progress for 1.75 seconds
